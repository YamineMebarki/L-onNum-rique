...
// Returns the private 'App\Repository\ArticleSearchTypeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ArticleSearchTypeRepository.php';

return $this->privates['App\\Repository\\ArticleSearchTypeRepository'] = new \App\Repository\ArticleSearchTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
