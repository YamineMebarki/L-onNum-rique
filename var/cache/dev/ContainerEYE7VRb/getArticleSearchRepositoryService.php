...
// Returns the private 'App\Repository\ArticleSearchRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ArticleSearchRepository.php';

return $this->privates['App\\Repository\\ArticleSearchRepository'] = new \App\Repository\ArticleSearchRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
