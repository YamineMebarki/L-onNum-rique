...
class Category extends \App\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'title', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'content', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'article'];
        }
     ...
     * {@inheritDoc}
     */
    public function setContent(string $content): \App\Entity\Category
    {
