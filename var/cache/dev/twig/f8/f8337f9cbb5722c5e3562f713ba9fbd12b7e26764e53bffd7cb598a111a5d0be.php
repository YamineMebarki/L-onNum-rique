...
class __TwigTemplate_6ce7b43e13be2752cb6570fda43f59dbdfbe93f0c4ff2266963b4b92c2cd351d extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "vendor/symfony/web-profiler-bundle/Resources/views/Collector/logger.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "vendor/symfony/web-profiler-bundle/Resources/views/Collector/logger.html.twig"));

        // line 3
        $macros["helper"] = $this->macros["helper"] = $this;
        // line 1
        $this->parent = $this->loadTemplate("@WebProfiler/Profiler/layout.html.twig", "vendor/symfony/web-profiler-bundle/Resources/views/Collector/logger.html.twig", 1);
    ...
    public function block_menu($context, array $blocks = [])
    {
        ...
        echo " ";
        echo ((twig_test_empty(twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 35, $this->source); })()), "log", [], "any", false, false, false, 35))) ? ("disabled") : (""));
        echo "\">
        <span class=\"icon\">";
        // line 36
        echo twig_include($this->env, $context, "@WebProfiler/Icon/logger.svg");
...
";
    ...
    ";
        // line 49
        if (twig_test_empty(twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 49, $this->source); })()), "log", [], "any", false, false, false, 49))) {
            // line 50
    ...
    ";
            ...
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 57, $this->source); })()), "log", [], "any", false, false, false, 57));
        ...
        <div class=\"sf-tabs\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["log"]) {
                // line 137
                echo "                ";
                $context["compilerLogTotal"] = ((isset($context["compilerLogTotal"]) || array_key_exists("compilerLogTotal", $context) ? $context["compilerLogTotal"] : (function () { throw new RuntimeError('Variable "compilerLogTotal" does not exist.', 137, $this->source); })()) + twig_length_filter($this->env, $context["log"]));
                // line 138
                echo "            ";
            }
            $_parent = $context['_parent'];
            ...
            if (twig_test_empty(twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 144, $this->source); })()), "compilerLogs", [], "any", false, false, false, 144))) {
                ...
                foreach ($context['_seq'] as $context["class"] => $context["log"]) {
                    // line 159
                    echo "                                    <tr class=\"\">
                    ...
                    // line 173
                    echo twig_escape_filter($this->env, twig_length_filter($this->env, $context["log"]), "html", null, true);
                    echo "</td>
                                    </tr>
                                ";
                    ++$context['loop']['index0'];
                ...
                $_parent = $context['_parent'];
                unset($context['_seq'], $context['_iterated'], $context['class'], $context['log'], $context['_parent'], $context['loop']);
                $context = array_intersect_key($context, $_parent) + $_parent;
                // line 176
                echo "                            </tbody>
                        </table>
    ...
    public function macro_render_table($__logs__ = null, $__category__ = "", $__show_level__ = false, $__is_deprecation__ = false, ...$__varargs__)
    {
        ...
        try {
            ...
            // line 190
            echo "    ";
            $context["channel_is_defined"] = twig_get_attribute($this->env, $this->source, twig_first($this->env, (isset($context["log"]) || array_key_exists("log", $context) ? $context["log"] : (function () { throw new RuntimeError('Variable "log" does not exist.', 190, $this->source); })())), "channel", [], "any", true, true, false, 190);
            // line 191
            echo "    ";
    ...
    <table class=\"log\"";
        ...
        <tbody>
            ...
            // line 203
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["log"]) || array_key_exists("log", $context) ? $context["log"] : (function () { throw new RuntimeError('Variable "log" does not exist.', 203, $this->source); })()));
            $context['loop'] = [
              'parent' => $context['_parent'],
              'index0' => 0,
              'index'  => 1,
...
";
    ...
    {
        return "vendor/symfony/web-profiler-bundle/Resources/views/Collector/logger.html.twig";
    }
...
{% block menu %}
    <span class=\"label label-status-{{ collector.counterrors ? 'error' : collector.countdeprecations or collector.countwarnings ? 'warning' }} {{ collector.log is empty ? 'disabled' }}\">
    ...
    {% else %}
        ...
        <div class=\"sf-tabs\">
            ...
            {% for log in collector.compilerLogs %}
                {% set compilerLogTotal = compilerLogTotal + log|length %}
            {% endfor %}
            <div class=\"tab\">
                ...
                <div class=\"tab-content\">
                    ...
                    {% else %}
                        <table class=\"log\">
                            ...
                            <tbody>
                                {% for class, log in collector.compilerLogs %}
                                    <tr class=\"\">
                                        <td class=\"font-normal\">
                                        ...
                                        <td class=\"font-normal text-right\">{{ log|length }}</td>
                                    </tr>
                                {% endfor %}
                            </tbody>
                        </table>
...
{% macro render_table(log, category = '', show_level = false, is_deprecation = false) %}
    {% import _self as helper %}
    {% set channel_is_defined = (log|first).channel is defined %}
    {% set filter = show_level or channel_is_defined %}

    <table class=\"log\"{% if show_level %} data-filter-level=\"Emergency,Alert,Critical,Error,Warning,Notice,Info\"{% endif %}{% if filter %} data-filters{% endif %}>
        <thead>
            <tr>
...
{% macro render_log_message(category, log_index, log) %}
    ...
    {% endif %}
{% endmacro %}
", "vendor/symfony/web-profiler-bundle/Resources/views/Collector/logger.html.twig", "/var/www/public/DevLaon/templates/vendor/symfony/web-profiler-bundle/Resources/views/Collector/logger.html.twig");
    }
}
