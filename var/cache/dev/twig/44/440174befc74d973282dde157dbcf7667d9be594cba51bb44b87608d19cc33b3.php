...
class __TwigTemplate_8f2cb3b74965d1990cdd652aedb07c17ed9984c2f78994b359b700d2d17d8d69 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"sf-tabs\">
        ...
        if ((isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new RuntimeError('Variable "logger" does not exist.', 57, $this->source); })())) {
            ...
            if (twig_get_attribute($this->env, $this->source, (isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new RuntimeError('Variable "logger" does not exist.', 65, $this->source); })()), "logs", [], "any", false, false, false, 65)) {
                // line 66
                echo "                    ";
                echo twig_include($this->env, $context, "@Twig/Exception/log.html.twig", ["logs" => twig_get_attribute($this->env, $this->source, (isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new RuntimeError('Variable "logger" does not exist.', 66, $this->source); })()), "logs", [], "any", false, false, false, 66)], false);
                echo "
                ";
            } else {
                // line 68
...
<div class=\"container\">
    <div class=\"sf-tabs\">
        ...
        <div class=\"tab {{ logger.logs is empty ? 'disabled' }}\">
            ...
            <div class=\"tab-content\">
                {% if logger.logs %}
                    {{ include('@Twig/Exception/log.html.twig', { logs: logger.logs }, with_context = false)  }}
                {% else %}
                    <div class=\"empty\">
                        <p>No log messages</p>
                    </div>
...
", "@Twig/Exception/exception.html.twig", "/var/www/public/L@nNumérique/vendor/symfony/twig-bundle/Resources/views/Exception/exception.html.twig");
    }
}
