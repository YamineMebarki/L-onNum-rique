...
class __TwigTemplate_156b074f05e47ef8aee1c43b76ab39ced87836be2af3e754c7f3d1bf4b0baf30 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "vendor/swiftmailer/swiftmailer/tests/unit/Swift/MessageTest.php"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "vendor/swiftmailer/swiftmailer/tests/unit/Swift/MessageTest.php"));
...
class Swift_MessageTest extends \\PHPUnit\\Framework\\TestCase
{
    ...
    {
        \$message1 = new Swift_Message('DevLaon');
        \$html = new Swift_MimePart('<html></html>', 'text/html');
        \$html->getHeaders()->addTextHeader('X-DevLaon-Remove', 'DevLaon-Value');
        \$html->getHeaders()->addTextHeader('X-DevLaon-Alter', 'DevLaon-Value');
        ...
        foreach (\$message2->getChildren() as \$child) {
            \$child->setBody('DevLaon');
            \$child->getHeaders()->removeAll('X-DevLaon-Remove');
            \$child->getHeaders()->get('X-DevLaon-Alter')->setValue('Altered');
        }
...
";
    ...
    {
        return "vendor/swiftmailer/swiftmailer/tests/unit/Swift/MessageTest.php";
    }
...
", "vendor/swiftmailer/swiftmailer/tests/unit/Swift/MessageTest.php", "/var/www/public/DevLaon/templates/vendor/swiftmailer/swiftmailer/tests/unit/Swift/MessageTest.php");
    }
}
