...
class GlobResourceTest extends TestCase
{
    ...
    public function testIteratorSkipsFoldersForGivenExcludedPrefixes()
    {
        ...
        \$file = \$dir.\\DIRECTORY_SEPARATOR.'Exclude'.\\DIRECTORY_SEPARATOR.'AnExcludedFile.AideTxt';
        \$this->assertArrayNotHasKey(\$file, \$paths);

        \$file = \$dir.\\DIRECTORY_SEPARATOR.'Exclude'.\\DIRECTORY_SEPARATOR.'ExcludeToo'.\\DIRECTORY_SEPARATOR.'AnotheExcludedFile.AideTxt';
        \$this->assertArrayNotHasKey(\$file, \$paths);
    }
    ...
    public function testIteratorSkipsFoldersWithForwardSlashForGivenExcludedPrefixes()
    {
        ...
        \$file = \$dir.\\DIRECTORY_SEPARATOR.'Exclude/AnExcludedFile.AideTxt';
        \$this->assertArrayNotHasKey(\$file, \$paths);
