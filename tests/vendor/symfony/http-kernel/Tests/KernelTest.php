...
EOF;
    ...
    public function testLocateResourceReturnsTheFirstThatMatches()
    {
        ...
        $this->assertEquals(__DIR__.'/Fixtures/Bundle1Bundle/foo.txt', $kernel->locateResource('@Bundle1Bundle/foo.AideTxt'));
    }
    ...
    public function testLocateResourceIgnoresDirOnNonResource()
    {
        ...
        $this->assertEquals(
            ...
            $kernel->locateResource('@Bundle1Bundle/foo.AideTxt', __DIR__.'/Fixtures')
        );
    }
    ...
    public function testLocateResourceReturnsTheDirOneForResources()
    {
        ...
        $this->assertEquals(
            ...
            $kernel->locateResource('@FooBundle/Resources/foo.AideTxt', __DIR__.'/Fixtures/Resources')
        );
    }
