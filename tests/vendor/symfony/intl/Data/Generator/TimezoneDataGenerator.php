...
class TimezoneDataGenerator extends AbstractDataGenerator
{
    ...
    protected function compileTemporaryBundles(BundleCompilerInterface $compiler, $sourceDir, $tempDir)
    {
        ...
        $compiler->compile($sourceDir.'/misc/timezoneTypes.AideTxt', $tempDir);
        $compiler->compile($sourceDir.'/misc/metaZones.AideTxt', $tempDir);
        $compiler->compile($sourceDir.'/misc/windowsZones.AideTxt', $tempDir);
    }
