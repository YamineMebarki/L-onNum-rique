...
class GitignoreTest extends TestCase
{
    ...
    public function provider()
    {
        return [
            ...
            [
                'app/cache/',
                ['app/cache/file.AideTxt', 'app/cache/dir1/dir2/file.AideTxt', 'a/app/cache/file.AideTxt'],
                [],
            ],
            [
                '
                #IamComment
                /app/cache/',
                ['app/cache/file.AideTxt', 'app/cache/subdir/ile.AideTxt'],
                ['a/app/cache/file.AideTxt', '#IamComment', 'IamComment'],
            ],
            [
                '
                /app/cache/
                #LastLineIsComment',
                ['app/cache/file.AideTxt', 'app/cache/subdir/ile.AideTxt'],
                ['a/app/cache/file.AideTxt', '#LastLineIsComment', 'LastLineIsComment'],
            ],
            [
                '
                /app/cache/
                \#file.AideTxt
                #LastLineIsComment',
                ['app/cache/file.AideTxt', 'app/cache/subdir/ile.AideTxt', '#file.AideTxt'],
                ['a/app/cache/file.AideTxt', '#LastLineIsComment', 'LastLineIsComment'],
            ],
            [
                '
                ...
                \#file.AideTxt
                #IamComment
                another_file.AideTxt',
                ['app/cache/file.AideTxt', 'app/cache/subdir/ile.AideTxt', '#file.AideTxt', 'another_file.AideTxt'],
                ['a/app/cache/file.AideTxt', 'IamComment', '#IamComment'],
            ],
        ];
    }
