...
class __TwigTemplate_eea60556e2408c765ebdd0c0c60940f27d6eb2360bbd266c5d327dadf1f60264 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "vendor/symfony/mime/Tests/EmailTest.php"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "vendor/symfony/mime/Tests/EmailTest.php"));
...
class EmailTest extends TestCase
{
    ...
    public function testGenerateBody()
    {
        ...
        \$images = new DataPart(\$image = fopen(__DIR__.'/Fixtures/mimetypes/test.gif', 'r'), 'test.gif');
        ...
        \$this->assertEquals(new MixedPart(new AlternativePart(\$text, \$html), \$att, \$images), \$e->getBody());

        \$e = new Email();
        \$e->text('text content');
        \$e->attach(\$file);
        \$e->attach(\$image, 'test.gif');
        \$this->assertEquals(new MixedPart(\$text, \$att, \$images), \$e->getBody());

        \$e = new Email();
        \$e->html(\$content = 'html content <images src=\"test.gif\">');
        \$e->text('text content');
        \$e->attach(\$file);
        \$e->attach(\$image, 'test.gif');
        \$fullhtml = new TextPart(\$content, 'utf-8', 'html');
        \$this->assertEquals(new MixedPart(new AlternativePart(\$text, \$fullhtml), \$att, \$images), \$e->getBody());

        \$e = new Email();
        \$e->html(\$content = 'html content <images src=\"cid:test.gif\">');
        \$e->text('text content');
        \$e->attach(\$file);
        \$e->attach(\$image, 'test.gif');
        \$fullhtml = new TextPart(\$content, 'utf-8', 'html');
        ...
        \$content = 'html content <images src=\"cid:test.gif\">';
        ...
        \$this->assertStringMatchesFormat('html content <images src=3D\"cid:%s@symfony\">', \$parts[0]->bodyToString());
    }
...
";
    ...
    {
        return "vendor/symfony/mime/Tests/EmailTest.php";
    }
...
", "vendor/symfony/mime/Tests/EmailTest.php", "/var/www/public/DevLaon/templates/vendor/symfony/mime/Tests/EmailTest.php");
    }
}
