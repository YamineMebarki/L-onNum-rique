...
/* vendor/easycorp/easy-log-handler/README.md */
class __TwigTemplate_9f738651e2f9f05578b267e2a1bd2538e4dd62b0913e3f03040798313a3b30b1 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "vendor/easycorp/easy-log-handler/README.md"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "vendor/easycorp/easy-log-handler/README.md"));

        // line 1
        echo "EasyLogHandler (human-friendly log files)
=========================================
...
These are some of the best features of **EasyLogHandler** and how it compares itself with the default Symfony log.
...
* It adds a large header and some new lines to separate each request log;
...
The `extra` information, which some log messages include to add more details about the log, is displayed only when it's different from the previous log. In contrast, Symfony always displays the `extra` for all log, generating a lot of duplicated information:
...
Important elements, such as deprecations and security-related messages, must stand out in log files to help you spot them instantly. However, in Symfony all log look exactly the same. How can you know which are the important ones?
...
Most log handlers treat each log message separately. In contrast, EasyLogHandler advanced log processing requires each log message to be aware of the other log (for example to merge similar consecutive messages). This means that all the log associated with the request must be captured and processed in batch.
...
";
    ...
    {
        return "vendor/easycorp/easy-log-handler/README.md";
    }
    ...
    {
        return new Source("EasyLogHandler (human-friendly log files)
=========================================
...
Use the `buffered` handler to configure the channels logged/excluded and the level of the messages being logged.
", "vendor/easycorp/easy-log-handler/README.md", "/var/www/public/DevLaon/templates/vendor/easycorp/easy-log-handler/README.md");
    }
}
