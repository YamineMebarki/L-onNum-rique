...
class __TwigTemplate_08af5635d045973b28eede2f094b3203d1891ae79b7c1ddfc46d1afffe1152cc extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "vendor/swiftmailer/swiftmailer/tests/unit/Swift/Mime/Headers/UnstructuredHeaderTest.php"));
...
class Swift_Mime_Headers_UnstructuredHeaderTest extends \\SwiftMailerTestCase
{
    ...
    public function testBasicStructureIsKeyValuePair()
    {
        ...
        */
        \$header = \$this->getHeader('Subject', \$this->getEncoder('Q', true));
        \$header->setValue('DevLaon');
        \$this->assertEquals('Subject: DevLaon'.\"\\r\\n\", \$header->toString());
    }
    ...
    public function testPrintableAsciiOnlyAppearsInHeaders()
    {
        ...
        */
        ...
        \$header = \$this->getHeader('X-DevLaon', \$this->getEncoder('Q', true));
    ...
    public function testEncodedWordIncludesCharsetAndEncodingMethodAndText()
    {
        ...
        */
        ...
        \$header = \$this->getHeader('X-DevLaon', \$encoder);
        \$header->setValue(\$nonAsciiChar);
        \$this->assertEquals(
            'X-DevLaon: =?'.\$this->charset.'?Q?=8F?='.\"\\r\\n\",
            \$header->toString()
            );
    }
    ...
    public function testFWSPIsUsedWhenEncoderReturnsMultipleLines()
    {
        ...
        */
        ...
        \$this->assertEquals(
            'X-DevLaon: =?'.\$this->charset.'?Q?line_one_here?='.\"\\r\\n\".
     ...
     */
        ...
        \$this->assertEquals('X-DevLaon: start =?'.\$this->charset.'?Q?'.
...
";
    ...
    {
        return "vendor/swiftmailer/swiftmailer/tests/unit/Swift/Mime/Headers/UnstructuredHeaderTest.php";
    }
...
", "vendor/swiftmailer/swiftmailer/tests/unit/Swift/Mime/Headers/UnstructuredHeaderTest.php", "/var/www/public/DevLaon/templates/vendor/swiftmailer/swiftmailer/tests/unit/Swift/Mime/Headers/UnstructuredHeaderTest.php");
    }
}
