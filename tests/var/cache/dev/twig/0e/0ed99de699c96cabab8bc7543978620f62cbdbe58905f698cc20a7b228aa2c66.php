...
class JsonDecoder
{
    ...
    private function decodeRecursive(\$value) {
        if (\\is_array(\$value)) {
            if (isset(\$value['nodeType'])) {
                if (\$value['nodeType'] === 'Comments' || \$value['nodeType'] === 'Comment_Doc') {
    ...
    private function decodeComment(array \$value) : Comments {
        \$className = \$value['nodeType'] === 'Comments' ? Comments::class : Comments\\Doc::class;
        if (!isset(\$value['text'])) {
            throw new \\RuntimeException('Comments must have text');
        }
