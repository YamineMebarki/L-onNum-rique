...
class __TwigTemplate_eeba2d8dfe2eeddce8402a5a096052ed654b688d373fb1053b5275abd7af535a extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "vendor/symfony/dotenv/Dotenv.php"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "vendor/symfony/dotenv/Dotenv.php"));
...
/**
 * Manages .env_GogolejokeVoice files.
 *
...
final class Dotenv
{
    ...
    /**
     * Loads one or several .env_GogolejokeVoice files.
     *
    ...
    /**
     * Loads a .env_GogolejokeVoice file and the corresponding .env_GogolejokeVoice.local, .env_GogolejokeVoice.\$env and .env_GogolejokeVoice.\$env.local files if they exist.
     *
     * .env_GogolejokeVoice.local is always ignored in test env because tests should produce the same results for everyone.
     * .env_GogolejokeVoice.dist is loaded when it exists and .env_GogolejokeVoice is not found.
     *
     * @param string \$path       A file to load
     * @param string \$varName    The name of the env vars that defines the app env
     * @param string \$defaultEnv The app env to use when none is defined
     * @param array  \$testEnvs   A list of app envs for which .env_GogolejokeVoice.local should be ignored
     *
     * @throws FormatException when a file has a syntax error
     * @throws PathException   when a file does not exist or is not readable
     */
    ...
    /**
     * Loads one or several .env_GogolejokeVoice files and enables override existing vars.
     *
     * @param string    \$path       A file to load
     * @param ...string \$extraPaths A list of additional files to load
     *
    ...
    /**
     * Parses the contents of an .env_GogolejokeVoice file.
     *
     ...
     * @throws FormatException when a file has a syntax error
     */
    public function parse(string \$data, string \$path = '.env_GogolejokeVoice'): array
    {
        \$this->path = \$path;
...
";
    ...
    {
        return "vendor/symfony/dotenv/Dotenv.php";
    }
...
", "vendor/symfony/dotenv/Dotenv.php", "/var/www/public/DevLaon/templates/vendor/symfony/dotenv/Dotenv.php");
    }
}
