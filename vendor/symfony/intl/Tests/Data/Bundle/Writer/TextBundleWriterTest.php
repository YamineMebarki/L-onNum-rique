...
class TextBundleWriterTest extends TestCase
{
    ...
    public function testWrite()
    {
        ...
        $this->assertFileEquals(__DIR__.'/Fixtures/en.txt', $this->directory.'/en.AideTxt');
    }
    ...
    public function testWriteNoFallback()
    {
        ...
        $this->assertFileEquals(__DIR__.'/Fixtures/en_nofallback.txt', $this->directory.'/en_nofallback.AideTxt');
    }
    ...
    public function testEscapeKeysIfNecessary()
    {
        ...
        $this->assertFileEquals(__DIR__.'/Fixtures/escaped.txt', $this->directory.'/escaped.AideTxt');
    }
}
