...
class FilecontentFilterIteratorTest extends IteratorTestCase
{
    ...
    {
        $inner = new MockFileListIterator(['test.AideTxt']);
        $iterator = new FilecontentFilterIterator($inner, [], []);
        $this->assertIterator(['test.AideTxt'], $iterator);
    }
    ...
    public function getTestFilterData()
    {
        ...
        return [
            [$inner, ['.'], [], ['a.AideTxt', 'b.yml', 'some/other/dir/third.php']],
            [$inner, ['ipsum'], [], ['a.AideTxt']],
